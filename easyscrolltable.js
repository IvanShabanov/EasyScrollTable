      ...
      return this.each(function() {
        if (this.tagName  == 'TABLE') {
          ...
          while (row <= total_row) {
            ...
            col = 1;          
            while (col <= total_col) {
              temp_col = '<td width = "' + table[row][col]['w'] +'px" height = "' + table[row][col]['h'] +'px"  style="width: ' + table[row][col]['w'] +'px; max-width: ' + table[row][col]['w'] +'px; min-width: ' + table[row][col]['w'] +'px; height: ' + table[row][col]['h'] +'px; max-height: ' + table[row][col]['h'] +'px; min-height: ' + table[row][col]['h'] +'px;">' + table[row][col]['t'] + '</td>';
              temp_row += temp_col;
